                ...
                <div className='border-2 shadow-lg bg-white rounded-md mb-10 ms-7 lg:w-3/5 md:w-5/6 w-10/12 xl:p-10 md:p-5 p-2'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            ...
                            <form className='lg:w-full w-10/12 md:text-xl text-sm'>

                                    <label className=' md:text-lg text-sm'>project_title:</label>
                                    <input type="text" name="project_title" value={project_title} className='border border-black p-1 md:text-lg rounded-md md:h-8 h-7 ' onChange={handleChange('project_title')} />

                                    <label className='md:text-lg text-sm'>category:</label>
                                    <select type="text" name="category" className='border border-black p-1 md:text-lg rounded-md md:h-8 h-7 ' onChange={handleChange('category')} ref={sel_ref} >
                                        ...
                                        <input type="text" name="language" value={language} className='border border-black p-1 md:text-lg rounded-md md:h-8 h-7' onChange={handleChange('language')} />

                                        <label className='md:text-lg'>tools:</label>
                                        <input type="text" name="tools" value={tools} className='border border-black p-1 md:text-lg rounded-md md:h-8 h-7' onChange={handleChange('tools')} />

                                        <label htmlFor='image' className='md:text-lg'>project_image:</label>
                                        <input type="file" id='image' name="project_image" className='border border-black p-1 md:text-lg rounded-md md:h-8 h-7' onChange={handleChange('project_image')} ref={file_ref} />
                            </form>
